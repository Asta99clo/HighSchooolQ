      ...
      {SOCIAL_MEDIA_PLATFORMS.map(platform => {
        ...
        if (url) {
          return (
            <a 
              key={platform.key}
              href={platform.key === 'email' ? `mailto:${url}` : url}
...
const CardProfesorItem = ({ profesor, index }) => {
  ...
  return (
    <div 
      className="profesor-card-container" 
      style={animationDelay}
    >
      <div className={`profesor-card-inner ${isFlipped ? 'is-flipped' : ''}`}>
