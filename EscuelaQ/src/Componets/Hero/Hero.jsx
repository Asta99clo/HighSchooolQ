import './Hero.scss';
import heroImagen from '/img/Hero/Hero-02.webp';
    ...
    return (
        <section className="hero-contenedor">
            <div className="hero-texto">
                ...
                <p>
                    Tu plataforma para conectar, aprender y crecer. Descubre un
                    espacio diseñado para potenciar tu talento y prepararte para
                    el futuro.
                </p>
